...
cvlc --play-and-exit "/home/alumno/Descargas/pokemon.mp3" &>/dev/null&
sleep 2
clear

echo " Hola, bienvenido al laboratoro Pokémon, oh perdón todavia no me he presentado, soy el profesor Caspian(y Tutor Honorífico), ven conmigo te dare tu pokemon"
...
menu(){ 
cvlc --play-and-exit "/home/alumno/Descargas/soniatheme.mp3" &>/dev/null&
sleep 2
...
clear
echo "------------------------------------------"
echo "Recibiste [Pokeballs] del profesor Caspian"
echo "------------------------------------------"
    sleep 2
    echo "pulsa enter para continuar..."
    read enter
...
Fin(){
    clear
    sleep 2
    echo "Vaya, parece que se te dan bien"
    sleep 2
    echo "Bueno creeo que $pokemon y tu estasis listos para ir a por la lider Sonia "
    ...
    echo "Bueno creeo que $pokemon y tu estais listos para ir a por la lider Sonia "    
    echo "Ella es la lider de ciudad Intalia, y su gimnasio es tipo bicho"
    sleep 10
Comienzo
}
